            ...
            <div class="col-md-12">
                ...
                <div class="row mb-2 card-header py-1">
                        <div class="col-sm-6 col-md-6">
                            <div class=" ">
                                <h3 class="card-title font-weight-bold">
                                    <img src="https://cdn-icons-png.flaticon.com/128/1022/1022215.png" style="width: 30px;">Edit Leave Form
                                </h3>
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <form action="" method="post">
                        ...
                        <input type="hidden" name="emp_id" value="<?= $edit_data->emp_id ?>">
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control" id="leave_date_from" name="leave_date_from"
                                    placeholder="Enter leave date" value="<?= $edit_data->leave_date_from ?>" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="leave_date_to">Leave To*</label>
                                <input type="date" class="form-control" id="leave_date_to"
                                    value="<?= $edit_data->leave_date_to ?>" name="leave_date_to" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="leave_date_to">Nature Of Leave*</label>
                                <select name="nature_of_leave" class="form-control1 select" required>
                                    <option value="1" <?= ($edit_data->nature_of_leave == 1) ? "selected" : "" ?>><?= $this->config->item('leave_type')[1]?></option>
                                    <option value="2" <?= ($edit_data->nature_of_leave == 2) ? "selected" : "" ?>><?= $this->config->item('leave_type')[2]?></option>
                                    <option value="3" <?= ($edit_data->nature_of_leave == 3) ? "selected" : "" ?>><?= $this->config->item('leave_type')[3]?></option>
                                    <option value="4" <?= ($edit_data->nature_of_leave == 4) ? "selected" : "" ?>><?= $this->config->item('leave_type')[4]?></option>
                                </select>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="leave_reson">Leave Reson*</label>
                                <input type="text" class="form-control" id="leave_reson" name="leave_reson"
                                    value="<?= $edit_data->leave_reson ?>" placeholder="Enter leave reson" required>
                            </div>
                            <div class="form-group col-md-2">
                                <button type="submit"
                                    class="submitBtn btn btn-primary font-weight-bold mt-4 py-2">Submit</button>
                            </div>
                        </div>
