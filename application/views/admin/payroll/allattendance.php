        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="card cardData p-2 border-0" style="background-color:#e3e3e3;">
                    <a href='<?= base_url() ?>admin/payroll/allattendance'>
                        <div class="card-body p-0">
                            <div>
                                <div class='text-center mt-2'>
            ...
            <div class="tab-pane fade active show" id="payroll-list" role="tabpanel">
                <div class="card">
                    <div class="card-header d-flex">
                        ...
                        <button type="button" class="btn add_btn" title="Add Attendance Sheet" data-toggle="modal"
                            data-target="#staticBackdrop">
                            <i class="bi bi-plus fa-1x snone" ></i>Add
                        </button>
                    </div>
                    <div class="card-body p-0">
                            ...
                            <table id="example" class="table table-striped w-100">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="customth">Attandance Date</th>
                                        <th class="customth">Created</th>
                                        <th class="customth">Updated</th>
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('admin/payroll/all_attendance_list') ?>" + type,
...
jQuery(document).ready(function() {
    jQuery(document).on("click", ".deleteAttendanceBtn", function() {
        var tableId = $(this).attr("data_id");
        currentRow = $(this);


        hitURL = "<?php echo base_url() ?>admin/payroll/deleteAttendance";
