                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <select name="event_type" class="form-control" id="event_type">
                                    ...
                                    <option value="1"><?= $this->config->item('event_type')[1]?></option>
                                    <option value="2"><?= $this->config->item('event_type')[2]?></option>
                                    <option value="3"><?= $this->config->item('event_type')[3]?></option>
                                </select>
                            </div>

                            <div class="form-group col-md-4 employeeInpute d-none">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control" id="event_date" name="event_date"
                                    placeholder="Enter Events date" required>
                            </div>
                            
                            <div class="form-group col-md-4">
                                <label for="event_time">Events Time*</label>
                                <input type="time" class="form-control" id="event_time" name="event_time"
                                    placeholder="Enter Events Time">
                            </div>

                            <div class="form-group col-md-4">
                                <label for="event_heading">Events Title*</label>
                                <input type="text" class="form-control" name="event_heading" placeholder="Events Title" required>
                            </div>
