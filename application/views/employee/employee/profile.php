        ...
        <div class="tab-pane" role="tabpanel">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="media-body text-left">
                                ...
                                <?php $verifyBtn = '<span class="badge bg-inverse-success btn" data-toggle="modal" data-target="#policeCode">Add</span>'?>
                                ...
                                <p class="mb-1"><b>Police Verified Code:</b>
                                    <?= (!empty($view_data->police_code))?$view_data->police_code.' '.$viewCode:$verifyBtn;?>
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="media-body text-left p-0">
                                        ...
                                        <p class="mb-1"><b><svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                    ...
                                                    viewBox="0 0 16 16" style="margin-left: -3px;">
                                ...
                                <div class="row">
                                    <div class="media-body text-left p-0">
                                        <p class="mb-1"><b><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                ...
                                                </svg> Bank Name:</b> <?= $view_data->bank_name;?>
                                        </p>
                                        <p class="mb-1"><b><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                        ...
                                        <p class="mb-1"><b><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                    ...
                                                    <path
                                                        d="M2.873 11.297V4.142H1.699L0 5.379v1.137l1.64-1.18h.06v5.961h1.174Zm3.213-5.09v-.063c0-.618.44-1.169 1.196-1.169.676 0 1.174.44 1.174 1.106 0 .624-.42 1.101-.807 1.526L4.99 10.553v.744h4.78v-.99H6.643v-.069L8.41 8.252c.65-.724 1.237-1.332 1.237-2.27C9.646 4.849 8.723 4 7.308 4c-1.573 0-2.36 1.064-2.36 2.15v.057h1.138Zm6.559 1.883h.786c.823 0 1.374.481 1.379 1.179.01.707-.55 1.216-1.421 1.21-.77-.005-1.326-.419-1.379-.953h-1.095c.042 1.053.938 1.918 2.464 1.918 1.478 0 2.642-.839 2.62-2.144-.02-1.143-.922-1.651-1.551-1.714v-.063c.535-.09 1.347-.66 1.326-1.678-.026-1.053-.933-1.855-2.359-1.845-1.5.005-2.317.88-2.348 1.898h1.116c.032-.498.498-.944 1.206-.944.703 0 1.206.435 1.206 1.07.005.64-.504 1.106-1.2 1.106h-.75v.96Z" />
                                                </svg> IFSC Code:</b> <?= (isset($view_data->ifsc_code) && !empty($view_data->ifsc_code))?$view_data->ifsc_code:"N/A";?></p>
                                        <p class="mb-1"><b><i class="bi bi-paperclip"></i> Bank Attachment:</b> 
                                        <a href="<?= (isset($view_data->bank_attachment) && !empty($view_data->bank_attachment))?base_url().$view_data->bank_attachment:"#"?>"
                                                class="btn btn-primary text-light px-2 py-0" title="View Passbook" disabled target="_blank"> <i class="bi bi-eye"></i></a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="card px-0">
                    <div class="row card-header wwss">
                            <div class="col-sm-6 col-md-6 p-0">
                                <h4>Other Info <i class="bi bi-info-circle"></i></h4>
                            </div>
                            <div class="col-sm-6 col-md-6 p-0">
                                <div class="header-action " style="float:right;">
                                    <a href="<?= isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : '#';?>" title="Go Back">
...
<div class="modal show" id="policeCode" data-target="#policeCode" data-backdrop="static" data-keyboard="false"
    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modelWid">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold" id="policeCodeTitle"> Police Verification Form
                </h5>
                <button type="button" class="close text-primary " data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url()?>employee/profile/addPoliceCode" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card shadow-md border">
                                <div class="row">
                                    <div class="col-md-12 col-lg-12 col-12">
                                        <label for="employee" class="form-label label-text">Police Verification
                                            Code*</label>
                                        <input type="text" name="police_code" class="form-control"
                                            placeholder="Police Verification Code" required>
                                    </div>

                                    <div class="col-md-12 col-lg-12 col-12">
                                        <label for="employee" class="form-label label-text">Upload ScreenShort*</label>
                                        <input type="file" name="police_code_file" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                        </div>
