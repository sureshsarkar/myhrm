                    ...
                    <a href='<?= base_url('admin/employee?type=new_emp')?>'>
                        <div class="card-body p-0">
                            <div>
                                ...
                                <p class='font-weight-bold text-muted text-center' style="font-size:12px;">New Employee
                                </p>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href='<?= base_url('admin/employee?type=v_emp') ?>'>
                        <div class="card-body p-0">
                            <div>
                                ...
                                <p class='font-weight-bold text-muted text-center' style="font-size:12px;">Verifed
                                    Employee</p>
                            </div>
                        </div>
                    </a>
