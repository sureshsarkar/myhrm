                ...
                <div class="row mb-2 card-header py-1">
                        ...
                        <div class="col-sm-6">
                            <div class="header-action " style="float:right;">
                                <a href="<?= base_url()?>admin/policy" title="Go Back">
                                    <button type="button" class="btn add_btn" fdprocessedid="lxdxe"><img
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="policy_name" name="policy_name"
                                    placeholder="Policy Name" value="<?= $edit_data->policy_name?>" required>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <input type="hidden" name="old_policy_file" value="<?= $edit_data->policy_file?>">
                            </div>
                            <div class="form-group col-md-2">
                                <br> 
                                <br> 
                                <a href="<?= base_url().$edit_data->policy_file?>"
                                    target="_blank"> 
                                    <i class="bi bi bi-eye-fill mt-2" ></i>
                                </a>
                            </div>
                            <div class="form-group col-md-2">
                                <button type="submit"
