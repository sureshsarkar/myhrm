                                ...
                                <div class="col-lg-12">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="site-branding mr-auto">
                                            <div class="logo" title="Leading - Digital Marketing & Web Designing Company Noida" >

                                                <a class="home-link" href="<?= base_url()?>" alt="TechCentrica - Digital Marketing & Web Designing Company Noida" title="TechCentrica - Digital Marketing & Web Designing Company Noida" rel="home">
                                                    <img id="logo-img" class="img-fluid" src="<?= base_url()?>assets/images/logo.png" alt="TechCentrica - Digital Marketing & Web Designing Company Noida" title="TechCentrica - Digital Marketing & Web Designing Company Noida">
                                                </a></div>
                                        </div><!-- site-branding end -->
                                       <!-- widget-info -->
                                        <div class="widget_info d-flex flex-row align-items-center justify-content-end">
                                            <div class="widget_content">
											<img id="logo-img" class="img-fluid" src="<?= base_url()?>assets/images/CMMI.png" >
                                                
                                            </div>
                                        </div><!-- widget-info end -->
                                        <div class="widget_info d-flex flex-row align-items-center justify-content-end">
                                            <div class="widget_content">
											<img id="logo-img" class="img-fluid" src="<?= base_url()?>assets/images/premier-google - Copy.png" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="site-navigation" class="site-navigation">
                                    <div class="ttm-rt-contact">
                                        <div class="ttm-custombutton">
                                         <a class="ttm-btn ttm-btn-size-md  ttm-btn-bgcolor-skincolor" href="<?= base_url('contact-us/contact-location')?>">START A PROJECT</a>
                                        </div>
                                    </div>
                                   ...
                                   <nav id="menu" class="menu">
                                        ...
                                        <?php 
                                            ...
                                            <li>
                                                ...
                                                <?php }else{?>
                                                    <a href="<?= base_url().$value->slug?>" class="<?= (isset($page) && $page==$value->cat_name)?"active":""?>"><?= $value->cat_name?></a>
                                                <ul>
