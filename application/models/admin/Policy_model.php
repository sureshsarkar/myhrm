...
class Policy_model extends Base_model
{
    ...
    var $column_order = array('policy_name','status','created_at','updated_at'); //set column field database for datatable orderable

    var $column_search = array('policy_name','status','created_at','updated_at'); //set column field database for datatable searchable 
    ...
    public function _get_datatables_query($where = NULL)
    {
        ...
        // $this->db->select('holiday.*,e.fname,e.lname,e.phone,e.email,e.role');
    ...
    public function jointTables()
    {
        ...
        // $this->db->join('employee as e ', ' e.id = holiday.emp_id');
