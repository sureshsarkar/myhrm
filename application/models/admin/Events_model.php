...
class Events_model extends Base_model
{
    ...
    var $column_order = array(null, 'event_date','event_time','event_heading','event_content','status','created_at','updated_at'); //set column field database for datatable orderable

    var $column_search = array('event_date','event_time','event_heading','event_content','status','created_at','updated_at'); //set column field database for datatable searchable 
    ...
    public function _get_datatables_query($where = NULL)
    {
        ...
        // $this->db->select('events.*,e.fname,e.lname,e.phone,e.email,e.role');
    ...
    public function jointTables()
    {
        ...
        // $this->db->join('employee as e ', ' e.id = events.emp_id');
