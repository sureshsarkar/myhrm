...
class Holiday_model extends Base_model
{
    ...
    var $column_order = array(null, 'day_name','date_from','date_to','holiday_reason','status','created_at','updated_at'); //set column field database for datatable orderable

    var $column_search = array('day_name','date_from','date_to','holiday_reason','status','created_at','updated_at'); //set column field database for datatable searchable 
