...
class Job_module extends Base_model
{
    public $table = "job_module";

    var $column_order = array(null,'id','designation','experience','date_limit','status','created_at','updated_at'); //set column field database for datatable orderable

    var $column_search = array('id','designation','experience','date_limit','status','created_at','updated_at'); //set column field database for datatable searchable 
    ...
    public function jointTables()
    {
        ...
        // $this->db->join('employee as e ', ' e.id = leave_management.emp_id');
