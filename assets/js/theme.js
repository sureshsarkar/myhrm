...
/****************case-study-blog-industry-we-serve-showcase**********/
 ...
 $(document).ready(function(){
  $('#box-hover-change1').mouseenter(function(){
  $('#image-hover-change1').attr('src',"img/Blog-Grey.jpg");
  });
  $('#box-hover-change1').mouseleave(function(){
  $('#image-hover-change1').attr('src',"img/Blog.jpg");
  });
  });

  
  $(document).ready(function(){
  $('#box-hover-change2').mouseenter(function(){
  $('#image-hover-change2').attr('src',"img/Industry-Serve-Grey.jpg");
  });
  $('#box-hover-change2').mouseleave(function(){
  $('#image-hover-change2').attr('src',"img/Industry-Serve.jpg");
  });
  });

  
  $(document).ready(function(){
  $('#box-hover-change3').mouseenter(function(){
  $('#image-hover-change3').attr('src',"img/Case-Study-Grey.jpg");
  });
  $('#box-hover-change3').mouseleave(function(){
  $('#image-hover-change3').attr('src',"img/Case-Study.jpg");
  });
  });
